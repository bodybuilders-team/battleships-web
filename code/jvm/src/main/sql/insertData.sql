...
INSERT INTO games(creator, name, grid_size, max_time_for_layout_phase, shots_per_round, max_time_per_shot, phase,
                  round, turn, winner)
VALUES (2, 'Game 1', 10, 60, 1, 10, 'WAITING_FOR_PLAYERS', NULL, NULL, NULL),
       (3, 'Game 2', 16, 60, 2, 20, 'WAITING_FOR_PLAYERS', NULL, NULL, NULL),
       (4, 'Game 3', 12, 60, 1, 30, 'WAITING_FOR_PLAYERS', NULL, NULL, NULL);
